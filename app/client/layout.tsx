      ...
      <div className="profile-bar">
        <div className="flex items-center justify-between px-6 py-3">
          <Link href="/client/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-[#FF6B35] hidden sm:inline">Nthoppa</span>
          </Link>

          <div className="flex-1 text-center">
            <h1 className="text-lg font-semibold text-gray-900">
              {navItems.find(nav => nav.href === pathname)?.name || 'User Portal'}
            </h1>
          </div>

          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="relative" onClick={() => router.push('/client/notifications')}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <footer className="mt-8 pt-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
              ...
              <span className="flex items-center gap-1"><Activity className="h-3 w-3 text-[#FF6B35]" /> Real-time Monitoring</span>
