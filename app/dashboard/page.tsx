  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        {/* BEHAVIOURAL TRACKING DATA SECTION */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-5">
            <div>
        ...
        {/* NTHOPPA SURE — FINTECH MARKETPLACE DIVISION - Fixed with Link */}
        ...
        {/* MERCHANT ACCOUNTS SECTION - Fixed with router.push */}
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-5">
            <div>
