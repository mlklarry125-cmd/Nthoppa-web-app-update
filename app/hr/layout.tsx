      ...
      <div className="profile-bar">
        <div className="flex items-center justify-between px-6 py-3">
          <Link href="/hr/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-[#FF6B35] hidden sm:inline">Nthoppa HR</span>
          </Link>

          <div className="flex-1 text-center">
            <h1 className="text-lg font-semibold text-gray-900">
              {navItems.find(nav => nav.href === pathname)?.name || 'HR Portal'}
            </h1>
          </div>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2">
                  ...
                  <div className="hidden md:block text-left">
                    <p className="text-sm font-medium">{hrName || "HR Manager"}</p>
